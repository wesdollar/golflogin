...
<div id="content-container">
    <div class="container double-margin">
        ...
        <div class="row double-margin">
            ...
            @include('partials.contactSidebar')

            <div class="col-md-8">
                <p class="big-font">
                    Thank you for contacting us! We usually respond to all requests pretty quickly. We're a two man team, so we do get backed up from time to time. If you need immediate assistance, please feel free to give us a call!
                </p>
            </div>
        </div>
...
<div class="container double-margin" id="photo-section">
    <div class="row">
        <div class="col-md-6">
            ...
            <p class="double-margin">
                Golf Login is available on any device with an internet / 3G / 4G LTE data connection. You and your team will have full access to and full control of your system no matter where you are.
            </p>
            <p>
            ...
            <p class="center double-margin">
                <a href="{{ route('buy') }}" class="btn btn-lg btn-primary">Sign Up Now!</a>
            </p>
        </div>
