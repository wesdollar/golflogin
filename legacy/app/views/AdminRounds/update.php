...
<?php
    ...
    <div class="box">
        ...
        <!-- begin pasted form Rounds/update.php -->

        <form id="frmCreateRound" name="frmCreateRound" class="frm frmSave contMessage" method="post" action="<?php $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
        ...
        if (!empty($tpl['course'])) {
            if (empty($tpl['round']['nine_start']) || $tpl['round']['nine_start'] == 'front') {
                ...
                <table cellpadding="0" cellspacing="0" class="courseCard">
                    <tr>
                        <th colspan="10" class="alignCenter tbl-header"><?php echo $GTM_LANG['Rounds']['create']['front_9']; ?></th>
                    </tr>
            ...
            if ($tpl['round']['type'] == '18_STATS' || $tpl['round']['type'] == '18_NO_STATS' || (!empty($tpl['round']['nine_start']) && $tpl['round']['nine_start'] == 'back') ) {
                ...
                <table cellpadding="0" cellspacing="0" class="courseCard">
                    <tr>
                        <th colspan="10" class="alignCenter tbl-header"><?php echo $GTM_LANG['Rounds']['create']['back_9']; ?></th>
                    </tr>
                    <tr class="hole-header">
                        <th class="alignLeft"><?php echo $GTM_LANG['Rounds']['create']['hole']; ?></th>
                        <?php
            ...
            ?>
            <p><input class="button1" type="submit" value="Update Round" /></p>
        <?php
