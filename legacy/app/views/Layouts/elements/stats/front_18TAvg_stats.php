<?php
if (!empty($tpl['ranking']['18_tournament_avg']) && $tpl['ranking']['18_tournament_avg'] && is_array($tpl['ranking']['18_tournament_avg'])) {
	?>
	<div class="box2B<?php echo $is_rankings ? ' marR8' : null; ?>">
		<div class="box2C">
			<table width="234" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<th class="tit01"><img src="<?= WEB_URL; ?>img/h3_18_hole.gif" alt="" width="169" height="30" />
					</th>
				</tr>
			</table>
			<table width="222" border="0" cellpadding="0" cellspacing="0" class="marRL5">
				...
				<?php
				$i = 1;
				$total_rows = count($tpl['ranking']['18_tournament_avg']);
				
				foreach ($tpl['ranking']['18_tournament_avg'] as $key => $val) {
					?>
					<tr class="<?php echo $i%2 == 0 ? 'bgdBox203' : 'bgdBox202'; ?>">
						...
						<td valign="top" class="<?php echo $i == $total_rows ? 'borNone ' : null; ?>last"><?php echo $val['18_tournament_avg']; ?></td>
					</tr>
					<?php
					$i ++;
				}
