<?php
if (!empty($tpl['ranking']['handicap_index']) && $tpl['ranking']['handicap_index'] && is_array($tpl['ranking']['handicap_index'])) {
	?>
	<div class="box2B<?php echo $is_rankings ? ' marR8' : null; ?>">
		<div class="box2C">
			<table width="234" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<th><img src="<?= WEB_URL; ?>img/h3_box2_03.gif" alt="" width="202" height="13" /></th>
				</tr>
			</table>
			<table width="222" border="0" cellpadding="0" cellspacing="0" class="marRL5">
				...
				<?php
				$i = 1;
				$total_rows = count($tpl['ranking']['handicap_index']);
				
				foreach ($tpl['ranking']['handicap_index'] as $key => $val) {
					?>
					<tr class="<?php echo $i%2 == 0 ? 'bgdBox203' : 'bgdBox202'; ?>">
						...
						<td valign="top" class="<?php echo $i == $total_rows ? 'borNone ' : null; ?>last"><?php echo $val['handicap_index']; ?></td>
					</tr>
					<?php
					$i ++;
				}
