<?php
if (!empty($tpl['ranking']['par_breakers']) && $tpl['ranking']['par_breakers'] && is_array($tpl['ranking']['par_breakers'])) {
	?>
	<div class="box2B marC<?php echo $is_rankings ? ' marR8' : null; ?>">
		<div class="box2C">
			<table width="234" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<th><img src="<?= WEB_URL; ?>img/h3_box2_11.gif" alt="" width="108" height="13" /></th>
				</tr>
			</table>
			<table width="222" border="0" cellpadding="0" cellspacing="0" class="marRL5">
				...
				<?php
				$i = 1;
				$total_rows = count($tpl['ranking']['par_breakers']);
				
				foreach ($tpl['ranking']['par_breakers'] as $key => $val) {
					?>
					<tr class="<?php echo $i%2 == 0 ? 'bgdBox203' : 'bgdBox202'; ?>">
						...
						<td valign="top" class="<?php echo $i == $total_rows ? 'borNone ' : null; ?>last"><?php echo number_format($val['par_breakers']*100, 2); ?></td>
					</tr>
					<?php
					$i ++;
				}
